...
function Dibujar()
	...
	if CONTROL.ESTILO == 1 and LISTAS.SCREENSHOT_FULL == false then
		...
		if LISTAS.SCREENSHOT_ON == true then 
			if LISTAS.SCREENSHOT ~= nil and LISTAS.EXISTE_SCR == true then
				Graphics.drawScaleImage(LISTAS.SCREENSHOT,CONTROL.IMG_ANCHO+LISTAS.SCR_FIX,CONTROL.IMG_ALTO+LISTAS.SCR_FIX_Y,LISTAS.SCR_X,LISTAS.SCR_Y)
			else
			...
			if LISTAS.COVER_ART ~= nil and LISTAS.EXISTE_COV == true then
				Graphics.drawScaleImage(LISTAS.COVER_ART,CONTROL.IMG_ANCHO+LISTAS.COV_FIX,CONTROL.IMG_ALTO+LISTAS.COV_FIX_Y,LISTAS.COV_X,LISTAS.COV_Y)
			else
				if LISTAS.MOSTRAR <= LISTAS.ART_LIMITE then
					Font.ftPrint(CONTROL.fontARCA,CONTROL.IMG_ANCHO+38,CONTROL.IMG_ALTO+70,0,0,8,"-LOADING ART-",COLOR.BLANCO)
				else
	...
	elseif CONTROL.ESTILO == 2 and LISTAS.SCREENSHOT_FULL == false then
		...
		if LISTAS.COVER_ART2 ~= nil and LISTAS.EXISTE_COV2 == true then
			Graphics.drawScaleImage(LISTAS.COVER_ART2,CONTROL.IMG_ANCHO-180+LISTAS.COV_1_FIX,CONTROL.IMG_ALTO+40+LISTAS.COV_1_FIX_Y,LISTAS.COV_1_X,LISTAS.COV_1_Y)
		else
			if LISTAS.MOSTRAR <= LISTAS.ART_LIMITE then
		...
		if LISTAS.COVER_ART3 ~= nil and LISTAS.EXISTE_COV3 == true then
			Graphics.drawScaleImage(LISTAS.COVER_ART3,CONTROL.IMG_ANCHO+270+LISTAS.COV_2_FIX,CONTROL.IMG_ALTO+40+LISTAS.COV_2_FIX_Y,LISTAS.COV_2_X,LISTAS.COV_2_Y)
		else
			if LISTAS.MOSTRAR <= LISTAS.ART_LIMITE then
	...
	elseif CONTROL.ESTILO == 3 and LISTAS.SCREENSHOT_FULL == false then
		...
		if LISTAS.SCREENSHOT_ON == true then 
			if LISTAS.SCREENSHOT ~= nil and LISTAS.EXISTE_SCR == true then
				Graphics.drawScaleImage(LISTAS.SCREENSHOT,CONTROL.LISTA_ANCHO+LISTAS.SCR_FIX,CONTROL.IMG_ALTO+LISTAS.SCR_FIX_Y,LISTAS.SCR_X,LISTAS.SCR_Y)
			else
				if LISTAS.MOSTRAR <= LISTAS.ART_LIMITE then
			...
			if LISTAS.COVER_ART ~= nil and LISTAS.EXISTE_COV == true then
				Graphics.drawScaleImage(LISTAS.COVER_ART,CONTROL.LISTA_ANCHO+LISTAS.COV_FIX,CONTROL.IMG_ALTO+LISTAS.COV_FIX_Y,LISTAS.COV_X,LISTAS.COV_Y)
			else
				if LISTAS.MOSTRAR <= LISTAS.ART_LIMITE then
					Font.ftPrint(CONTROL.fontARCA,CONTROL.LISTA_ANCHO+38,CONTROL.IMG_ALTO+70,0,0,8,"-LOADING ART-",COLOR.BLANCO)
				else
	...
	elseif CONTROL.ESTILO == 5 and LISTAS.SCREENSHOT_FULL == false then
		...
		if LISTAS.SCREENSHOT ~= nil and LISTAS.EXISTE_SCR == true then
			Graphics.drawScaleImage(LISTAS.SCREENSHOT,CONTROL.IMG_ANCHO+320+LISTAS.SCR_FIX,CONTROL.IMG_ALTO+LISTAS.SCR_FIX_Y,LISTAS.SCR_X,LISTAS.SCR_Y)
		else
			if LISTAS.MOSTRAR <= LISTAS.ART_LIMITE then
	...
	elseif CONTROL.ESTILO == 6 and LISTAS.SCREENSHOT_FULL == false then
		...
		if LISTAS.SCREENSHOT ~= nil and LISTAS.EXISTE_SCR == true then
			Graphics.drawScaleImage(LISTAS.SCREENSHOT,CONTROL.IMG_ANCHO+LISTAS.SCR_FIX,CONTROL.IMG_ALTO+220+LISTAS.SCR_FIX_Y,LISTAS.SCR_X,LISTAS.SCR_Y)
		else
			if LISTAS.MOSTRAR <= LISTAS.ART_LIMITE then
	...
	if LISTAS.SCREENSHOT_FULL == true then
		...
		if LISTAS.SCREENSHOT_ON == true then 
			if LISTAS.SCREENSHOT ~= nil and LISTAS.EXISTE_SCR == true then
				...
				Graphics.drawScaleImage(LISTAS.SCREENSHOT,(60+(LISTAS.EX_FIX_S/2)+LISTAS.SCR_FIX)-(Right_Y/2)-(Right_X/2),15+(LISTAS.EX_FIX_S_Y/2)-(Right_Y/2)+CONTROL.Y_FIX_PAL,(LISTAS.SCR_X+LISTAS.EXPAN_IMG+Right_Y)-LISTAS.EX_FIX_S,(LISTAS.SCR_Y+LISTAS.EXPAN_IMG_Y+Right_Y)-LISTAS.EX_FIX_S_Y)
			else
			...
			if LISTAS.COVER_ART ~= nil and LISTAS.EXISTE_COV == true then
				Graphics.drawRect(35-(Right_Y/2)-(Right_X/2),5-(Right_Y/2)+CONTROL.Y_FIX_PAL,570+Right_Y,410+Right_Y,COLOR.NEGRO_T)
				Graphics.drawScaleImage(LISTAS.COVER_ART,(60+(LISTAS.EX_FIX_C/2)+LISTAS.COV_FIX)-(Right_Y/2)-(Right_X/2),15+(LISTAS.EX_FIX_C_Y/2)-(Right_Y/2)+CONTROL.Y_FIX_PAL,(LISTAS.COV_X+LISTAS.EXPAN_IMG+Right_Y)-LISTAS.EX_FIX_C,(LISTAS.COV_Y+LISTAS.EXPAN_IMG_Y+Right_Y)-LISTAS.EX_FIX_C_Y)
			else
				Graphics.drawRect(35,5+CONTROL.Y_FIX_PAL,570,410,COLOR.NEGRO_T)
				if LISTAS.MOSTRAR <= LISTAS.ART_LIMITE then
					Font.ftPrint(CONTROL.fontARCA,233,180+CONTROL.Y_FIX_PAL,0,0,8,"-LOADING ART-",COLOR.BLANCO)
